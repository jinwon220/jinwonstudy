...
public class Lecture {
    ...
    public String toString() {
        return "Lecture [lectureNo=" + lectureNo + ", lectureName=" + lectureName + ", teacherName=" + teacherName
                + ", classMaxNum=" + classMaxNum + ", startDate=" + startDate + ", endDate=" + endDate
                + ", lectureStartTime=" + lectureStartTime + ", lectureEndTime=" + lectureEndTime + "]";
    }
