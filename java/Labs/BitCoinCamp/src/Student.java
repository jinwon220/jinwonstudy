...
public class Student extends Member {
	...
	//학생의 정보를 가져오기
	Student(String id, String password, String name, int userLevel, String phoneNumber) {
	...
	*/
	void attendingCheck() {
		...
		System.out.println("번호\t학생이름\t강좌명\t\t\t날짜및시간\t\t출결여부\t");
	...
	*/
	public void consultingAdd() {
		...
		try {
			...
			String text = date.getDate(cal) + "\t" + takingLecture; //파일에 입력 될 내용
	...
	*/
	public void scoreCheck() {		
		...
		Iterator<Lecture> it = LectureList.s_getInstance().getLectureList().iterator();
        while(it.hasNext()) {
        	//LectureList안에 있는 Lecture의 강좌이름과 학생이 수강받고 있는 강좌이름 찾기
        	lectureName = it.next().getLectureName(); //강좌이름
            if(lectureName.equals(takingLecture)){ //이름이 같다면
            	break; //while 빠져나가기
            }
        }*/
